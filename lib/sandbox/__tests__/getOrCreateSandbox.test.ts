...
describe("getOrCreateSandbox", () => {
  ...
  it("creates new sandbox from snapshot with created=true and fromSnapshot=true", async () => {
    const mockSandbox = {
      sandboxId: "sbx_new",
      status: "running",
    } as unknown as Sandbox;
  ...
  it("creates fresh sandbox with created=true and fromSnapshot=false", async () => {
    const mockSandbox = {
      sandboxId: "sbx_fresh",
      status: "running",
    } as unknown as Sandbox;
