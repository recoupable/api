...
<p style="margin:0;font-size:38px;line-height:1.1;letter-spacing:-0.02em;font-weight:700;color:#0a0a0a">${formatUsd(valuation.mid)}</p>
<p style="margin:6px 0 0;font-size:13px;color:#6b6b6b">Range ${formatUsd(valuation.low)} to ${formatUsd(valuation.high)}</p>
</td></tr></table>`;
}
