...
describe("validateCreateChatBody", () => {
  describe("artistId validation", () => {
    it("accepts valid UUID for artistId", () => {
      ...
      expect((result as unknown).artistId).toBe("123e4567-e89b-12d3-a456-426614174000");
    });
  ...
  describe("chatId validation", () => {
    it("accepts valid UUID for chatId", () => {
      ...
      expect(result).not.toBeInstanceOf(NextResponse);
      expect((result as unknown).chatId).toBe("123e4567-e89b-12d3-a456-426614174000");
    });
  ...
  describe("accountId validation", () => {
    it("accepts valid UUID for accountId", () => {
      ...
      expect(result).not.toBeInstanceOf(NextResponse);
      expect((result as unknown).accountId).toBe("123e4567-e89b-12d3-a456-426614174000");
    });
    ...
    it("accepts missing accountId (optional)", () => {
      ...
      expect(result).not.toBeInstanceOf(NextResponse);
      expect((result as unknown).accountId).toBeUndefined();
    });
  });
  ...
  describe("firstMessage validation", () => {
    it("accepts valid string for firstMessage", () => {
      ...
      expect(result).not.toBeInstanceOf(NextResponse);
      expect((result as unknown).firstMessage).toBe("What marketing strategies should I use?");
    });
    ...
    it("accepts missing firstMessage (optional)", () => {
      ...
      expect(result).not.toBeInstanceOf(NextResponse);
      expect((result as unknown).firstMessage).toBeUndefined();
    });
    ...
    it("accepts empty string for firstMessage", () => {
      ...
      expect(result).not.toBeInstanceOf(NextResponse);
      expect((result as unknown).firstMessage).toBe("");
    });
  });
});
