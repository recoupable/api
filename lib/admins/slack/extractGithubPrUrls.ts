 ...
 *
 * @param text - The plain text body of the Slack message to scan for GitHub PR URLs.
 ...
 * @returns A deduplicated array of GitHub pull request URLs found across all message surfaces.
 */
