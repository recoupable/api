...
/**
 * Registers the "research_career" tool on the MCP server.
 * Returns an artist's career timeline — key milestones, trajectory, and career stage.
 *
 * @param server - The MCP server instance to register the tool on.
 */
export function registerResearchCareerTool(server: McpServer): void {
  server.registerTool(
    "get_artist_career",
    {
      description:
