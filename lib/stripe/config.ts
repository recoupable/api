...
>>>>>>> d9e795fa (feat(stripe): Stripe-first checkout: unauthenticated POST /api/subscriptions/checkout, account find-or-create on checkout.session.completed, POST /api/subscriptions/claim (row 8 of app#2044))
