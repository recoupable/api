 ...
 *
 * @param input - The input object containing the name, artist_address, and key_hash
 * @param input.name - The input object containing the name, artist_address, and key_hash
