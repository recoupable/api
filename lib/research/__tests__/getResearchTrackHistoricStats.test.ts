...
describe("getResearchTrackHistoricStats", () => {
  beforeEach(() => vi.clearAllMocks());

  it("passes through to Songstats tracks/historic_stats and returns data on 200, deducting credits", async () => {
    const payload = {
      result: "success",
      stats: [
        {
    ...
    const result = await getResearchTrackHistoricStats({
      accountId: "acc_1",
      params: { isrc: "USQY51771120", source: "spotify", start_date: "2024-06-09" },
    });
