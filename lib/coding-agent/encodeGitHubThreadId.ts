 ...
 *
 * @param thread - The GitHub thread ID object containing owner, repo, prNumber, and optional reviewCommentId
 * @returns The encoded thread ID string in Chat SDK format
 */
